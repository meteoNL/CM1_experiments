...
201     format(i6.6)
    ...
    IF( domse .and. imoist.eq.1 )THEN
      ...
      call writehf(1,dum2(ib,jb,2),dat1,dat2,dat3,reqt,orec,nvar,varname,vardesc,varunit)
    ...
    if( td_hadv.ge.1 .and. td_vadv.ge.1 )then
        ...
        call advs( 3 ,1,0,bfoo,xh,rxh,arh1,arh2,uh,ruh,xf,vh,rvh,gz,rgz,mh,rmh,           &
                   ...
                   td_hidiff,td_vidiff,td_hediff,wprof,dumk1,dumk2,hadvordrs,vadvordrs,n,0)
