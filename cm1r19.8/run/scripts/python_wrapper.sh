...
##srun -n1 python MSE_cross_whout.py  controlling_thetaadv_0.95 5.0 1.0 
##srun -n1 python MSE_cross.py controlling_thetaadv_0.95  5.0 1.0
srun -n1 python read_nc_CM1.py controlling_thetaadv_0.95 5.0 1.0
srun -n1 python make_cross_section.py controlling_thetaadv_0.95 5.0 1.0
##srun -n1 python wvalues.py controlling_thetaadv_0.95
##srun -n1 python dbzvalues.py controlling_thetaadv_0.95
