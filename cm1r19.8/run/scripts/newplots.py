...
list_full_names=["reference/rect.: 200m","Ensemble member 01","Ensemble member 02","Ensemble member 03","Ensemble member 04","Ensemble member 05","Ensemble member 06","Ensemble member 07","Ensemble member 08","Ensemble member 09","cubic: 200m","rect.: 1000m","rect.: 500m","lv x0.6","lv x0.8","lv x0.9","lv x1.1","lv x1.2","no vert. u/v adv.","vert. u/v adv. x0.5","vert. u/v adv. x0.8","vert. u/v adv. x1.5","cubic: 100m", r"vert. $q_{v}$ adv. x0.8",r"vert. $q_{v}$ adv. x1.2",r"vert. $\theta$ adv. x1.05",r"vert. $\theta$ adv. x1.10"]
...
list_styles = ["-","-","-","-","-","-","-","-","-","-","--",":","-","-","-","-","--","--","-","-","-","--","--","-","--",":",":"]
list_w = [10,2,2,2,2,2,2,2,2,2,6,6,3,3,3,3,5,5,3,3,3,5,8,3,5,4,6]
def readfiles(sim):
    '''
