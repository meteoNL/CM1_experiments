...
list_of_sims=["control_ref_200m","cubic_res_200m","ref_res_1km","ref_res_500m","controlling_lve_0.6","controlling_lve_0.8","controlling_lve_0.9","controlling_lve_1.1","controlling_lve_1.2","controlling_vadv_0.0","controlling_vadv_0.5","controlling_vadv_0.8","controlling_vadv_1.5","cubic_res_100m"]
list_full_names=["reference/rect.: 200m","cubic: 200m","rect.: 1000m","rect.: 500m","lv x0.6","lv x0.8","lv x0.9","lv x1.1","lv x1.2","no vert. u/v adv.","vert. u/v adv. x0.5","vert. u/v adv. x0.8","vert. u/v adv. x1.5","cubic: 100m"]
list_clrs =["black","grey","grey","grey",(0.4,0,0),(0.55,0,0),(0.7,0,0),(0.85,0,0),(1,0,0),(0,0.55,0),(0,0.7,0),(0,0.85,0),(0,1,0),"grey"]
list_styles = ["-","--",":","-","-","-","-","--","--","-","-","-","--","--"]
list_w = [10,6,6,3,3,3,3,5,5,3,3,3,5,8]
def readfiles(sim):
    '''
